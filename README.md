...
#### Font
When designing Rock, Paper, Scissors I wanted to give the site a clean and sophisticated, but yet soft look, and hence I chose a single font from Google Fonts called [Raleway](https://fonts.googleapis.com/css2?family=Raleway&display=swap) which I believe fulfills the stated purpose. 

#### Color Scheme
I chose a color scheme that gives the site a delicate look and well matches the icons. It was very important to me to ensure that the contrasting colors work well. I chose the default yellow color for the hands, hence on purpose not selecting a specific ethnicity or skin tone and therefore remaining neutral. I find that the bisque background-color goes well with the icons and chose black for the font to keep site neat. 
* Background-color: #ffe4c4
* Font-color: #000000

To check the contrasting colors I used (https://userway.org/). 

![Contrast Checker](docs/screenshots/contrast-checker.png)

### Wireframes
I used wireframes to plan my project. The main alteration I made was creating a hide-function to show only sign in area at first and then show only game area. The site looks pretty much the same regardless of which device it is being used on. 
...
* Score and previous choices are reset when the game is over, making it easy to start a new round. 
...
### Known Bugs
* When entering the site using iPhone, the site automatically zooms in. If you zoom out the page works as intended but each time you enter the site, and after entering username to get to the gamearea, you need to zoom out. Despite hours of online search and consulting my mentor I have not been able to fix this issue unfortunately. Note that this issue seems to only appear using iPhone, not Android and while playing the game it stays as intended. 
...
* [Favicon images](https://realfavicongenerator.net/) - For Favicon. 
